...
import './QuizStyles/Quiz.css'; // Import the CSS file
...
function QuizForm({ selectedOption, onCloseModal }) {
  ...
  return (
    <div>
      <div className="top-buttons"> {/* Add top-buttons class to this div */}
        <button onClick={handleAddQuestion}>New Question</button>
        <button onClick={handleSaveQuestions}>Done</button>
      </div>
